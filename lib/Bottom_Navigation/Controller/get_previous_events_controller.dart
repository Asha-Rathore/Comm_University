...
class GetPreviousEventsController extends GetxController {
  RxList<Events> previousEventList = <Events>[].obs;
  ...
  Future<void> getAllEvents() async {
    var response =
        await ApiService.get(NetworkStrings.getPreviousEventsEndPoint, true)
    ...
    if (response.statusCode == 200) {
      ...
      // print(obj);
      previousEventList.value = obj.events!;
      stopLoading();
